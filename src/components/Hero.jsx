...
const Hero = () => {
  ...
  // OPTIMASI: Parallax effect (y1) tetep jalan, tapi Opacity dibuang biar foto ga ngilang
  ...
  return (
    <section id="home" className="relative min-h-[100dvh] flex items-center pt-28 md:pt-20 overflow-hidden font-sans bg-[#050505]">
      ...
      <div className="max-w-[1440px] w-full mx-auto px-6 md:px-20 grid lg:grid-cols-12 gap-10 md:gap-12 items-center relative z-10 h-full">
        ...
        <motion.div 
          // FIX UTAMA: Hapus 'opacity' dari sini. Cuma pake 'y1' (parallax) aja.
          style={{ y: y1 }} 
          className="lg:col-span-5 relative h-[400px] sm:h-[500px] lg:h-[600px] flex items-center justify-center lg:justify-end mt-10 lg:mt-0"
        >
